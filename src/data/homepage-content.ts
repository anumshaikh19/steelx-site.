...
export const defaultHomepageContent = {
  ...
  products: [
    ...
    { name: "PVD Profiles — T, U & L Patti", description: "Decorative stainless-steel profiles in T, U, L, Collar, and Fluted configurations for edge detailing, cladding frames, rail infill, and architectural trim.", url: "/pvd-profiles" },
    { name: "PVD Lift Jamb & Cladding Panels", description: "PVD-coated panels designed for lift jamb cladding, elevator interiors, and corridor cladding in Mirror, Hairline, and Vibration textures.", url: "/lift-jamb-panels" },
    { name: "PVD Coated Pipes", description: "Decorative stainless-steel pipes with PVD surface finishes for architectural railings, furniture frames, structural elements, and designer fixtures.", url: "/pvd-coated-pipes" },
    { name: "TI-PVD Furniture Surfaces", description: "Tabletops, consoles, display showcases, partition panels, and decorative screens with full PVD surface treatment for demanding environments.", url: "/ti-pvd-furniture" },
  ],
  process: [
